...
<x-layout>
  ...
  <div class="overflow-hidden h-[400px] md:h-[400px]">
    <div class="bg-center bg-no-repeat bg-cover hover:scale-105 transition-transform duration-300 ease-in-out flex items-center justify-center" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('./images/About_us/join.png'); height: 400px;">
  ...
  <!-- Spacing -->
  <div class="my-12">
    <h1 class="text-4xl text-center  text-orange-600 hover:text-green-600 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
      Join The Team
    </h1>
  </div>
  <!-- Effect Image Hover -->
...
<div class="flex flex-col-reverse md:flex-row items-center justify-center mb-4 mx-auto text-center md:text-right" style="max-width: 80%;">
  <div class="mx-2 lg:mx-5 flex-none w-full md:w-2/5">
    <h2 class="text-8xl md:text-7xl font-oglnf text-orange_logo md:text-right">CONOR</h2>
