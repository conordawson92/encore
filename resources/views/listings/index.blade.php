      ...
      <div class="h-auto md:w-1/4 md:mr-4 mb-4 md:mb-0 p-2 bg-gray-50 relative"> 
        ...
        <div class="flex flex-wrap -m-2">
          <div class="p-2 w-1/2 md:w-full">
            <a href="?sort=priceAsc" class="block bg-orange-500 text-white rounded-none px-4 py-2 hover:bg-orange-600 w-full text-center">Price (Low to High)</a>
          </div>
          <div class="p-2 w-1/2 md:w-full">
            <a href="?sort=priceDesc" class="block bg-orange-500 text-white rounded-none px-4 py-2 hover:bg-orange-600 w-full text-center">Price (High to Low)</a>
          </div>
          <div class="p-2 w-1/2 md:w-full">
            <a href="?sort=newest" class="block bg-orange-500 text-white rounded-none px-4 py-2 hover:bg-orange-600 w-full text-center">Newest</a>
          </div>
          <div class="p-2 w-1/2 md:w-full">
